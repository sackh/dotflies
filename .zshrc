...
export ZSH="/Users/kharude/.oh-my-zsh"
...
alias c="clear"
alias sync="git fetch upstream; git checkout master; git merge upstream/master"
...
POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(status root_indicator background_jobs anaconda virtualenv time)
...
unset __conda_setup
# <<< conda initialize <<<
export PATH="$PATH:/Users/kharude/miniconda3/bin"
...
POWERLEVEL9K_VCS_UNTRACKED_BACKGROUND='darkgreen'
...
# DATA HUB
source ~/.here/xyz_token

# Location Services
export LS_API_KEY=PE0dg2-cFl4LR8XtFddnz7owA8qKvIeFwdrwo3hM3LY

# added by travis gem
[ ! -s /Users/kharude/.travis/travis.sh ] || source /Users/kharude/.travis/travis.sh
